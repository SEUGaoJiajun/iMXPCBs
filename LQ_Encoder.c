...
void LQ_ENC_Init(ENC_Type *base)
{
    if(base == ENC1)   //ECR 
    {
        ...
        XBARA_SetSignalsConnection(XBARA1, kXBARA1_InputIomuxXbarInout08, kXBARA1_OutputEnc1PhaseAInput);//H2  A相
        XBARA_SetSignalsConnection(XBARA1, kXBARA1_InputIomuxXbarInout09, kXBARA1_OutputEnc1PhaseBInput);//J2  B相或者方向
    ...
    else if(base == ENC2) //ECL
    {
        ...
        XBARA_SetSignalsConnection(XBARA1, kXBARA1_InputIomuxXbarIn21, kXBARA1_OutputEnc2PhaseBInput);//F14   B相或者方向
