...
#define LCD_SDA	PT1_1  
#define LCD_SCL	PT1_0 
...
void delay_10us(unsigned int Del_1ms)		//
{ 
  int i;
  while(Del_1ms--)
  {	
    for(i=0;i<300;i++) asm("NOP");//30000是1ms,300是100K
  }
}
/**********************************************
//IIC Start
...
{ 
  ...
  GPIO_PinInit(GPIO1, 0, &GPIO_Output_Config);      // BGA管脚D7  GPIO_AD_B0_00  GPIO1_IO00
  GPIO_PinInit(GPIO1, 1, &GPIO_Output_Config);      // BGA管脚E7  GPIO_AD_B0_01  GPIO1_IO01
